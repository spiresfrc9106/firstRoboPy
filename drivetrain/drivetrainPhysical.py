...
print(f"driveTrainPhysical.robotConfig={whichRobot.robotConfig}")

"""
Defines the physical dimensions and characteristics of the drivetrain
"""

if whichRobot.isCasserole():
    ###################################################################
...
elif whichRobot.isSpires2024Tomahawk():
    print(f'debug:isSpires2024Tomahawk={whichRobot.isSpires2024Tomahawk()}')
    ###################################################################
    # Physical dimensions and mass distribution
